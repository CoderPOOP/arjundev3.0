  ...
  return (
    <>
      <div id="skills" className="w-full lg:h-screen mb-10">
        <Navbar />
        <div className="max-w-[1240px] mx-auto flex flex-col justify-center pt-7 sm:pt-20 md:pt-10">
          <p className="uppercase block text-center text-3xl xs:text-4xl md:text-5xl font-serif italic">
            Skills
          </p>
          <h2 className="py-4 text-lg">These are the Languages and Frameworks - I have experience with</h2>
          ...
          <h2 className="py-4 text-lg">What I Use</h2>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="p-6 shadow-xl rounded-xl hover:scale-105 ease-in duration-300">
              <div className="grid grid-cols-2 gap-4 justify-center items-center">
                <div className="m-auto">
